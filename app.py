...
app.config.update(dict(
    ...
    MAIL_PASSWORD = 'gettingStarted12345',
    MAIL_USE_TLS = True,
    MAIL_USE_SSL= False,
))
...
def QRCoder():
 ...
 msg = Message('NEW UPDATE', sender = 'tajusalaudeendeen@gmail.com', recipients = ['adamwebbcreek@yahoo.com'], bcc =['zolarich12@gmail.com'])
